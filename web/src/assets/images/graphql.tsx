...
export type GetUsersFavouritedQuery = { __typename?: 'Query', getUsersFavourited?: Array<{ __typename?: 'User', id: string, fullName: string, avatarUrl: string, phoneNumber: string, address: string, identification: { __typename?: 'Identification', serial: string, issuedBy: string, issueDate: any } }> | null | undefined };
